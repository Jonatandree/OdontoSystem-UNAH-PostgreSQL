...
CREATE TABLE Parcial_Removible (
   ...
   Preparacion_boca_id INTEGER REFERENCES Preparación_boca_protesis_Removible(Preparación_bocaid),
   Preparacion_id INTEGER REFERENCES Preparación_protesis_Removible(Preparaciónid),
